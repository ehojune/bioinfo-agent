...
Six real runs, kept as documentation of what a run record looks like. Each is the five-file set the
agent writes into `runs/<runid>/`: `plan.md`, `samplesheet.csv`, `params.yaml`, `cmd.sh`,
`handoff.md`.
